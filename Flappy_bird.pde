...
void setup() {
   backpic =loadImage("https://github.com/Roy-zd/Flappy-Bird/blob/main/Backgroun2%20rescaled.jpg?raw=true");
   birdpic =loadImage("https://github.com/Roy-zd/Flappy-Bird/blob/main/Bird.png?raw=true");
   wallpic =loadImage("https://github.com/Roy-zd/Flappy-Bird/blob/main/wall.png?raw=true");
   welcomescreen=loadImage("https://github.com/Roy-zd/Flappy-Bird/blob/main/Start.jpg?raw=true");
